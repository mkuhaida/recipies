...
Для запуска приложения необходимо скачать Recipes/publish.zip и разархивировать его. Из папки запустить файл Recipes.exe. После чего по адресам http://localhost:5196 будет доступен сайт.
